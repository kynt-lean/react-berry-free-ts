...
export interface AvatarTypeMap<RootComponent extends React.ElementType = 'div'>
  extends MuiAvatarTypeMap<AvatarAdditionalProps, RootComponent> {}

export const Avatar = forwardRef(({ color, outline, size, sx, ...others }, ref) => {
