...
interface ChipTypeMap<RootComponent extends React.ElementType = 'div'> extends MuiChipTypeMap<ChipAdditionalProps, RootComponent> {}

const Chip = forwardRef(({ chipcolor, disabled, sx = {}, variant, ...others }, ref) => {
